    ...
    return (
        <div className="px-5">
            ...
            <div className="flex justify-center items-center mt-8  mb-8">
                ...
                <button
                    onClick={() => paginate(1)}
                    className="mx-1 px-3 py-1 rounded bg-[#030712] disabled:text-[#4b5563] disabled:bg-[#11182799] text-[#f9fafb]"
                ...
                <button
                    onClick={() => paginate(currentPage + 1)}
                    className="mx-1 px-3 py-1 rounded  bg-gray-200 bg-[#030712] disabled:text-[#4b5563] disabled:bg-[#11182799] text-[#f9fafb]"
