...
const InterviewPrepCard = ({ title, channel, url }) => {
                    ...
                    <div className=" mx-auto h-full p-4 bg-white border rounded-md shadow-sm flex flex-col justify-between cursor-pointer">
                        <div>
                            <div className="mt-2 flex justify-between">
                                <h2 href="#" className="text-lg leading-6 text-start font-semibold text-gray-800 tracking-normal h-24">
                                    {title}
                                </h2>
                            </div>
                        </div>
                        <div className="mt-4">
                            <p className="text-base tracking-normal font-medium" tabIndex="0" role="link">
                                {channel}
                            </p>
                        </div>
                    </div>
